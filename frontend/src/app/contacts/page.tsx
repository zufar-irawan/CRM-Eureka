...
export default function CompaniesList() {
  ...
  const handleRefresh = async () => {
    await fetchData({
      setData, setLoading, url: "/contacts/"
    });
  }
  ...
  return (
    <main className="p-4 overflow-visible lg:p-6 bg-white pb-6 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <DesktopTable pathname="/contacts/" columns={allColumns} visibleColumns={visibleColumns} loading={loading} setLoading={setLoading} searchTerm={debouncedSearch} onEdit={(row) => openModal(row)} rows={paginatedData} indexOffset={startIndex} />
