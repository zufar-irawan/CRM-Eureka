  ...
  useEffect(() => {
    const fetchDeals = async () => {
      try {
        ...
        // Mock data sesuai dengan format yang ada
        const mockDeals = [
          {
            id: '1',
      ...
      <div className="max-w-7xl mx-auto">
                ...
                <tr key={deal.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="text-sm font-medium text-gray-900">{deal.organization}</div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-blue-600 hover:underline cursor-pointer">{deal.email}</td>
                  <td className="px-6 py-4 text-sm text-gray-900">{deal.mobile}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">{deal.updated_at}</td>
            ...
            <div key={deal.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">{deal.organization}</h3>
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100">
                <span className="text-xs text-gray-500">{deal.updated_at}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mt-6 gap-4">
          <div className="text-sm text-gray-700">
            Showing <span className="font-medium">1</span> to <span className="font-medium">{deals.length}</span> of{' '}
