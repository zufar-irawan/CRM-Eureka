...
/**
 * Mengambil huruf pertama dari string, atau dua inisial jika multiWord = true.
 * @param value - Nilai yang ingin diambil inisialnya
 * @param fallback - Nilai default jika kosong
 * @param multiWord - Jika true, ambil inisial dari dua kata pertama
 * @returns Inisial huruf kapital
 */
