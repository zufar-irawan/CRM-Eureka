...
export default function DealsKanban() {
    ...
    const filterOptions = [
        { value: 'title', label: 'Title' }, { value: 'assigned__to', label: 'Assigned To' }
    ]
    ...
    const fetchDataWithFilter = useCallback(() => {
        ...
        fetchKanbanData({
            ...
            created_by: user?.isSales ? user.id : undefined,
            assigned_to: user?.isSales ? user.id : undefined
        })
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div className="flex flex-wrap gap-2">
                        ...
                        <div className="relative">
                            <button onClick={() => setShowFilterDropdown(!showFilterDropdown)} className="flex items-center gap-2 px-2.5 py-2 text-sm border border-gray-300 rounded-md bg-white hover:bg-gray-50 transition-colors">
