...
import { compressImage } from '@/app/tasks/detail/[id]/utils/imageCompression';
...
const TaskResultWithAttachment: React.FC<TaskResultWithAttachmentProps> = ({ taskId, onSuccess, onClose }) => {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <textarea
                                ...
                                className="mt-1 text-sm block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2"
                                rows={3}
                                required
                                disabled={isUploading}
                            />
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="mt-1 block w-full p-2 text-sm rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                disabled={isUploading}
                            >
